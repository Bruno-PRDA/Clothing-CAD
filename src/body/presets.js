...
export const BODY_PRESETS = Object.freeze({
  female_s: preset([160, 84, 72, 66, 92, 37, 33, 25.5, 22, 15, 51, 34.5, 21.5, 54, 74, 39, 21.5, 0.35, 30, 6]),
  female_m: preset([165, 88, 76, 70, 96, 38, 34, 27, 23, 15.5, 54, 36, 22, 56, 76, 40, 22, 0.4, 30, 6]),
  female_l: preset([170, 96, 82, 78, 104, 40, 35.5, 30, 25, 16.5, 58, 38, 23, 58, 78, 41.5, 22.5, 0.5, 30, 6]),
  male_s: preset([172, 92, 85, 78, 94, 44, 37.5, 28, 25.5, 17, 53, 36.5, 23, 60, 80, 43, 22.5, 0, 30, 6]),
  male_m: preset([178, 98, 90, 84, 98, 46, 39, 30, 27, 17.5, 56, 38, 23.5, 62, 82, 44, 23, 0, 30, 6]),
  male_l: preset([184, 108, 98, 96, 106, 48, 41, 33, 29, 18.5, 61, 40.5, 24.5, 64, 84, 46, 23.5, 0, 30, 6]),
  child_10: preset([140, 68, 62, 60, 72, 31, 28, 20, 18, 13, 40, 28, 19, 47, 65, 33, 20, 0, 30, 6]),
  plus_f: preset([168, 112, 98, 100, 122, 41, 38, 36, 28, 17.5, 68, 43, 25, 57, 76, 41, 22.5, 0.7, 32, 8]),
  athletic_m: preset([182, 104, 94, 82, 98, 49, 40, 34, 29, 18, 60, 40, 24, 64, 84, 45, 23, 0, 30, 6]),
});
